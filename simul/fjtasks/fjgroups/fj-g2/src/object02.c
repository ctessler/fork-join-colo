...
static double object(2) fabs(double n)
{
  double f;
...
static double object(2) log(double n)
{
   double result=1.0;
...
static double object(2) sin(double rad)
{
  double app;
...
static double object(2) cos(double rad)
{
  double sin();
...
int object(2) fft1(int n, int flag)
{
