...
def tasks_by_reuse(ctx):
    ...
    path = os.path.normpath(odir + '/tasks-by-reuse.eps')
    plt.savefig(path, bbox_inches='tight')
    plt.close()
...
def avg_reuse_by_set(ctx):
    ...
    plt.savefig(path, bbox_inches='tight')
    path = os.path.normpath(odir + '/avg-reuse-by-set.eps')
    plt.savefig(path, bbox_inches='tight')
    plt.close()
    logging.info(f'Wrote graph {path}')    
    return 0
...
def sched_by_set(ctx):
    ...
    plt.savefig(path, bbox_inches='tight')
    path = os.path.normpath(odir + '/sched-count-by-set.eps')
    plt.savefig(path, bbox_inches='tight')
    plt.close()
    logging.info(f'Wrote graph {path}')
    return 0
...
def pctsched_by_set(ctx):
    ...
    plt.savefig(path, bbox_inches='tight')
    path = os.path.normpath(odir + '/pctsched-count-by-set.eps')
    plt.savefig(path, bbox_inches='tight')
    plt.close()
    logging.info(f'Wrote graph {path}')
    return 0
